...
export default function Card({ pelicula = { titulo: "Sin titulo" }, botonTxt = "Ver mas", botonUrl = "#", img = defaultImg }) {
    ...
    return (
        <div className="rounded-xl bg-white w-64  m-4">
            <div>
                <img className="h-64 w-64 rounded object-cover" src={img} alt="image" />
            </div>
